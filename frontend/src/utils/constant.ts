...
export const csdnUrl = 'https://blog.csdn.net/weixin_44609676?spm=1001.2014.3001.5343';
...
// website start time
export const time = '2025-03-13 20:00:00';
...
export const myLink = 'https://jiliblogs.com';
// export const myAvatar = 'https://img.lzxjack.top:99/202203302154224.webp';
export const myDescr = 'a software engineer who is looking for a job and want to leave his footprints on the Internet.';
...
// default avatar, if user didn't upload their own avatar, use one of them instead
